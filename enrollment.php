...
<div class="container-fluid">
	<div class="card col-md-12">
		<div class="card-body">
			<div class="col-md-12">
				<br>
				<button type="button" class="btn btn-primary btn-sm btn-block col-sm-3" id="new_student"><i class="fa fa-plus"></i> Enroll student</button>
			</div>
			<br>
			<div class="col-md-12">
					...
					if(typeof resp != undefined){
						...
						if(Object.keys(resp).length > 0){
							...
							Object.keys(resp).map(k=>{
								...
								tr.append('<td><center><button class="btn btn-info btn-sm edit_student" data-id = "'+resp[k].id+'"></i> Update</button><br><button class="btn btn-danger btn-sm remove_student" style="margin-top: 3px" data-id = "'+resp[k].id+'"></i> Delete</button></center></td>')
