...
?>
	...
	<div class="col-md-6"style="margin: 20px">
		...
		<div class="form-group">				
			...
			<select name="level_section_id" id="level_section_id" class="custom-select browser-default"> 
				<!-- select2 -->
				<option ></option>
				<?php  
		...
		<div class="form-group">
			...
			<select name="student_id" id="student_id" class="custom-select browser-default">
				<option ></option>
				<?php  
